...
module.exports = {
  view() {
    return m('div', [
      ...
      m('p', `Da Innerrhoden schon fest in familiärer Hand ist, hat Aurel beschlossen den Westen zu infiltrieren und kam zur Tarnung an die ETH.
      ...
      m('p', `Geboren in Brasilien, aufgewachsen in Portugal, Deutschland, Frankreich und der Schweiz ist Patrick eine kosmopolitische Persönlichkeit.
      ...
      m('h4', 'Sandro Lutz - IT'),
      m('p', `Sandro ist der wohl erste IT-Vorstand, der keinen Kaffee trinkt. In seiner zweiten Amtszeit überschaut er einige grosse Informatikprojekte,
      ...
      m('p', `Wie so viele Info-Vorstände vor ihm kam Mathis buchstäblich im letzten Moment aus der neugewonnen Leere des dritten ET-Studienjahres zum AMIV.
      ...
      m('p', `Ruben war lange auf dem richtigen Weg im Leben. Nach einer soliden Ausbildung als Elektroniker und Lehrlingsausbildner
      ...
      m('p', `Mit einer frischen Matura in der Tasche kam Kira letztes Jahr an die ETH und somit in den amiv.
      ...
      m('p', `Tino ist momentan in seinem 5. Semester des Elektrotechnik Bachelors an der ETH. 
      ...
      m('p', `Annan studiert im 3. Semester Maschinenbau und hat sich trotz seines jungen Studenten-Alters von zarten 18 Jahren dazu entschieden,
      ...
      m('p', `Christian studiert Maschinenbau im fünften Semester des Bachelors.
      ...
      m('p', `Nenne irgendeine Kommission vom AMIV und man kann (mit 50% Wahrscheinlichkeit) sagen: Celina hat sie ausprobiert.
      ...
      m('p', `Um das ohnehin nicht sehr anspruchslose dritte Semester des Maschinenbaustudiums noch ein bisschen herausfordernder zu gestalten,
