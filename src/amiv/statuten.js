...
module.exports = {
  view() {
    ...
    <p> <br />
    Der AMIV (Akademischer Maschinen- und Elektroingenieur Verein an der Eidgenössischen Technischen Hochschule Zürich) ist 1893 gegründet worden und ist ein autonomer Fachverein gemäss der Statuten des Verbandes der Studierenden an der ETH (VSETH) und des Schweizerischen Zivilgesetzbuches (ZGB). Er ist der Fachverein der Studierenden an den Departementen <span><a href="http://www.mavt.ethz.ch/">“Maschinenbau und Verfahrenstechnik”</a></span> sowie <span><a href="http://www.ee.ethz.ch/">“Informationstechnologie und Elektrotechnik”</a></span>. Sitz des AMIV ist die Universitätsstrasse 6, 8092 Zürich.</p>
    ...
    </span>’S Der Quästor besorgt das Rechnungswesen. Die Details hierfür sind im “Finanzreglement des AMIV” im Anhang B dieser Statuten geregelt.<span><br />
